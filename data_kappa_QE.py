"""
Is based on s1_2_sims_QE_tester_crossmaps.py by Srini, but only for data

tSZ will be added in scl_cmb

add_noise is working fine for white noise, necessary changes should be made inorder to make it work for other spectrums

check degrade resol_fac parameter
"""
...
sims.fit_FG = None; sims.sehgal_fg_added = None
sims.Bl_gradient_map = Bl_gradient_map
